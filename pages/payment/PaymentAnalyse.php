 ...
 <div class="content-wrapper">
   ...
   <section class="content">
           ...
           <tbody>
             <?php
               ...
               <tr>
                   ...
                   <td>".$row['EtatAnalyse']."</td>
                  
                  
                   <td>
             
                   <a href=PaymentAnalyse.php?code=".$row['CodeAnalyseMed']."&Vue=ok><i class='fas fa-pen'></i> Régler </a>
                   </td>
               </tr>" ;
               }
               ?>
     ...
     <div class="card card-primary">
       ...
       <form method="POST" action="PaymentAnalyse.php">
       ...
       <div class="form-group">
                 ...
                 <div class="form-group">
                   <label for="exampleInputEmail1">ID Analyse :</label>
                   <input type="text" name="idcons" class="form-control" id="exampleInputEmail1" value="<?php if (!empty($rows333)) {echo $rows333['CodeAnalyseMed'];}?>" readonly="readonly" placeholder="ID Analyse">
                 </div>
...
<div class="form-group">
       ...
       <div class="form-group">
                   ...
                   <input type="text" readonly name="MontantRecu" class="form-control" id="exampleInputEmail1" value="<?php if (!empty($rows333)) {echo $rows333['PrixAnalyse'];}?>" placeholder="Montant">
       </div>

       <div class="form-group">
                   <label for="exampleInputEmail1">Date :</label>
                   <input type="date" name="DateRecu" class="form-control" id="exampleInputEmail1"  placeholder="Entrer Date recu" >
       </div>
